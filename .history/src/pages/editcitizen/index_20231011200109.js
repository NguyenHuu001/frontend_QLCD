    ...
    const fetchDetailCitizen = async () => {
        try {
            ...
            const responseTT = await getOneTT(IDTT).then((res) => {
                ...
                setHouseNumberTT(res.SoNha);
                setStreetNameTT(res.TenDuong);
                setSelectedCityTT(res.TinhThanh);
                setSelectedDistrictTT(res.QuanHuyen);
                setSelectedWardTT(res.PhuongXa);
            });
        } catch (error) {
            console.log('lỗi');
        }
