...
import { getAllCD, getAllDC, sortName, sortBirth, s } from '../../services/qlcd_services';
...
function Home() {
    ...
    const onSearchCCCD = (value, _e, info) => console.log(info?.source, value);
    const onSearchName = (value, _e, info) => console.log(info?.source, value);
    return (
