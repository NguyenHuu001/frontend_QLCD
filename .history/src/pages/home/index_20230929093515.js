    ...
    return (
        <div className="container mt-4 p-0">
            ...
            <div className="d-flex mt-3">
                ...
                <div className="col-md-1 item">Nguyễn Đức Hữu</div>
                <div className="col-md-1 item">11/11/2002</div>
                <div className="col-md-1 item">Nam</div>
                <div className="col-md-2 item">1234567890</div>
                <div className="col-md-4 item">Thôn Minh Đức, Xã Hòa Kiến, Tp.Tuy Hòa, Tỉnh Phú Yên</div>
            </div>
        </div>
    );
}
