...
function Home() {
    ...
    return (
        <div className="container mt-4 p-0">
            ...
            <div className="d-flex mt-4 ti">
                <div className="col-md-1 item"><b>STT</b></div>
                <div className="col-md-2 item"><b>Họ Tên</b></div>
                <div className="col-md-1 item"><b>Năm sinh</b></div>
                <div className="col-md-1 item"><b>Giới tính</b></div>
                <div className="col-md-1 item"><b>Số CCCD</b></div>
                <div className="col-md-3 item"><b>Địa chỉ thường trú</b></div>
            </div>
            {congDan &&
