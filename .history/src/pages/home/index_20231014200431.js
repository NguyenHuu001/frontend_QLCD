                ...
                congDan.map((item, index) => (
                    <div key={item._id}>
                        <div className="d-flex mt-3 no-wrap align-items-center">
                            <div className="col-md-1 item" sty>{index + 1}</div>
                            <div className="col-md-2 item" sty>{item.HoTen}</div>
                            <div className="col-md-1 item" sty>{item.NgaySinh}</div>
                            <div className="col-md-1 item" sty>{item.GioiTinh}</div>
                            <div className="col-md-1 item" sty>{item.SoCCCD}</div>
                            <div className="col-md-3 item" sty>{getDiaChi(item.DiaChiThuongTru)}</div>
