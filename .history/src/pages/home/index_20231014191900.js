...
import { getAllCD, getAllDC, sortName, sortBirth, searchCCCD, searchName,deleteCD,deleteDC } from '../../services/qlcd_services';
                        ...
                        <div className="d-flex mt-3 no-wrap align-items-center">
                            ...
                            <Link to="/editcitizen">
                                <button
                                    ...
                                    onClick={() =>
                                        edit(item.SoCCCD, item._id, item.DiaChiThuongTru, item.DiaChiTamTru)
                                    }
                                >
                                    Sửa
                                </button>
