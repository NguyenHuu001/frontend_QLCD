                ...
                congDan.map((item, index) => (
                    <div key={item._id}>
                        <div className="d-flex mt-3 no-wrap align-items-center">
                            <div className="col-md-1 item" style={{height:}}>{index + 1}</div>
                            <div className="col-md-2 item" style={{height:}}>{item.HoTen}</div>
                            <div className="col-md-1 item" style={{height:}}>{item.NgaySinh}</div>
                            <div className="col-md-1 item" style={{height:}}>{item.GioiTinh}</div>
                            <div className="col-md-1 item" style={{height:}}>{item.SoCCCD}</div>
                            <div className="col-md-3 item" style={{height:}}>{getDiaChi(item.DiaChiThuongTru)}</div>
