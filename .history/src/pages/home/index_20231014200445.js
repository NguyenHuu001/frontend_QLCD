                ...
                congDan.map((item, index) => (
                    <div key={item._id}>
                        <div className="d-flex mt-3 no-wrap align-items-center">
                            <div className="col-md-1 item" style={}>{index + 1}</div>
                            <div className="col-md-2 item" style={}>{item.HoTen}</div>
                            <div className="col-md-1 item" style={}>{item.NgaySinh}</div>
                            <div className="col-md-1 item" style={}>{item.GioiTinh}</div>
                            <div className="col-md-1 item" style={}>{item.SoCCCD}</div>
                            <div className="col-md-3 item" style={}>{getDiaChi(item.DiaChiThuongTru)}</div>
