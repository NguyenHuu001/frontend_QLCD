        ...
        <div className="container mt-5">
            <div className='d-flex'>
                ...
                <div className='col-md-9'>
                    ...
                    <div className='d-flex flex-column align-items-between' style={{height:'100%'}}>
                        <div className='d-flex justify-content-between'>
                            <span>Ngày sinh: <b>11/11/2002</b></span>
                            <span>Dân tộc: <b>Kinh</b></span>
                            <span>Quê quán: <b>Phú Yên</b></span>
                        </div>
                        <div className='d-flex justify-content-between'>
                            <span>Số CCCD: <b>123456789</b></span>
                        </div>
                    </div>
                </div>
            </div>
