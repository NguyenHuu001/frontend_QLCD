    ...
    const Okk = async () => {
        const newCD = {
            ...
            DiaChiThuongTru: {
                SoNha: '66',
                TenDuong: 'Hùng Vương',
                PhuongXa: 'P. Phú Nhuận',
                QuanHuyen: 'tp.Huế',
                TinhThanh: 'Thừa Thiên Huế',
            },
            DiaChiTamTru: {
                SoNha: '30',
                TenDuong: 'Hoàng Hoa Thám',
                PhuongXa: 'Phường 13',
        ...
        try {
            const response = await okkkk(newCD, newDC, newTT);
        } catch (error) {
            console.log('Lỗi');
        }
    };
