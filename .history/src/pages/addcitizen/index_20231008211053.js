...
function AddCitizen() {
    ...
    const handleAddAddress = () => {
        ...
        console.log(selectedCity, selectedDistrict, selectedWard, houseNumber, streetName);
        ...
        <div className="container mt-4 p-0">
            <div>
                <Input
                    placeholder="Số CCCD"
                    value={soCCCD}
                    onChange={(e) => setSoCCCD(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                />
                <Input
                    placeholder="Họ Tên"
                    value={hoTen}
                    onChange={(e) => setHoTen(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                />
                <DatePicker
                ...
                <Select
                    ...
                    value={gioiTinh}
                    onChange={(e) => setGioiTinh(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                >
                ...
                <Input
                    placeholder="Dân Tộc"
                    value={danToc}
                    onChange={(e) => setDanToc(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                />
                <Input
                    placeholder="Quốc Tịch"
                    value={quocTich}
                    onChange={(e) => setQuocTich(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                />
                <Input
                    placeholder="Quê Quán"
                    value={queQuan}
                    onChange={(e) => setQueQuan(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                />
                <div>
                ...
                <Input
                    placeholder="Số nhà"
                    value={houseNumber}
                    onChange={(e, value) => {setHouseNumber(e)console.log(value)}}
                    style={{ width: 200, marginLeft: 10 }}
                />
                <Input
                    placeholder="Tên đường"
                    value={streetName}
                    onChange={(e) => setStreetName(e.value)}
                    style={{ width: 200, marginLeft: 10 }}
                />
            </div>
