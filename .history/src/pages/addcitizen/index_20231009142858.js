...
function AddCitizen() {
    ...
    const [soNhaTT, setSoNhaTT] = useState('');
    const [tenDuongTT, setTenDuongTT] = useState('');
    const [phuongXaTT, setPhuongXaTT] = useState('');
    const [quanHuyenTT, setQuanHuyenTT] = useState('');
    const [tinhThanhT, setTinhThanhTT] = useState('');
