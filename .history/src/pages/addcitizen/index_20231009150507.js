...
function AddCitizen() {
    ...
    const handleCityChangeTT = (value) => {
        setSelectedCityTT(value);
        ...
        axios
            ...
            .then((response) => {
                setDistrictsTT(response.data.districtsTT);
            })
            .catch((error) => {
                console.error('Lỗi khi lấy danh sách quận/huyện', error);
            });
    };
    const handleDistrictChangeTT = (value) => {
        setSelectedDistrictTT(value);
        setSelectedWardTT('');
        setWardsTT([]);
        setResultTT('');
        ...
        axios
            ...
            .then((response) => {
                setWardsTT(response.data.wardsTT);
            })
            .catch((error) => {
                console.error('Lỗi khi lấy danh sách phường/xã', error);
            });
    };
    const handleWardChangeTT = (value) => {
        setSelectedWardTT(value);
        printResultTT();
    };
    const printResultTT = () => {
    ...
    const logdetail = () => {
        console.log(hoTenTT, soCCCDTT, soDTTT, emailTT, houseNumberTT, streetNameTT, wardsTT, districtsTT, citiesTT);
    };
    return (
                    ...
                    <div className="col-md-8 d-flex flex-column justify-content-between align-items-between ps-2">
                        ...
                        <div className="d-flex justify-content-between">
                            <Input
                                placeholder="Số nhà"
                                value={houseNumberTT}
                                onChange={(e) => setHouseNumberTT(e.target.value)}
                                style={{ width: '45%' }}
                            />
                            <Input
                                placeholder="Tên đường"
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <Button className="col-md-6" type="primary" onClick={handleAddAddressTT}>
                                Thêm Địa Chỉ
                            </Button>
                        </div>

                        <button onClick={logdetail}>ok</button>
                    </div>
                </div>
