...
function SuaTamTru() {
    ...
    const handleSubmit = () => {
        axios
            .put(`http://localhost:8000/api/suaTamTru/${ID}`, {
                HoTen: tamTru.HoTen,
    ...
    return (
        <div className="d-flex flex-column align-items-center">
            <h1 style={{ textDecoration: 'uppercase', color: '#a04244' }}>Sửa tạm trú</h1>
                ...
                <div className="col-md-5">
                    ...
                    {quanHeList.map((quanHe, index) => (
                        <div key={index}>
                            ...
                            <Button className="mt-3" type="primary" danger onClick={() => removeQuanHeField(index)}>
                                Xóa
                            </Button>
                        </div>
                    ))}
                    ...
                    <div className="d-flex justify-content-around">
                        <Button className="mt-3" type="dashed" onClick={addQuanHeField}>
                            Thêm quan hệ
                        </Button>
