...
const okkkk = (newCD, newDC, newTT) => {
    return instance.post('http://localhost:8000/api/add-info', newCD, newDC, newTT);
};
export { getAllCD, getOneCD, getAllDC, sortName, sortBirth, searchName, searchCCCD, getCDWithCCCD, getOneTT, getAllTT };
